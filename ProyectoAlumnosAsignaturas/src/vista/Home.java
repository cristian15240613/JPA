...
public class Home extends JFrame{
    ...
    public void armaHome(){
        ...
        pCuerpo.add(lbl1); pCuerpo.add(jTF1);
        pCuerpo.add(lbl2); pCuerpo.add(jTF2);
        pCuerpo.add(lbl3); pCuerpo.add(jTF3);
        pCuerpo.add(lbl4); pCuerpo.add(jTF4);
        pCuerpo.add(lbl5); pCuerpo.add(jTF5);       
    ...
    public void actualiza(){
        if(jCB.getSelectedItem().equals("Alumnos")){
            ...
            jpa.actualizaAsignatura(Integer.parseInt(jTF1.getText()), jTF2.getText(), jTF3.getText(), Integer.parseInt(jTF4.getText()));
            JOptionPane.showMessageDialog(this, "Registro actualizado");
        }else if(jCB.getSelectedItem().equals("Relaciones")){
